(() => {
  ...
  function patchLogin() {
    ...
    if (!form || form.dataset.accessV2Ready === '1') return;
    form.dataset.accessV2Ready = '1';
    ...
    form.addEventListener('submit', (event) => {
      ...
      const inputCode = document.getElementById('closePassword')?.value || '';
      const user = USERS[username];

      if (!user || inputCode.trim() !== ACCESS_CODE) {
